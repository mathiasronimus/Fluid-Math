define(["require", "exports", "./BezierCallback", "./Frame", "../main/consts"], function (require, exports, BezierCallback_1, Frame_1, consts_1) {
    "use strict";
    ...
    class MoveAnimation extends BezierCallback_1.default {
        constructor(start, end, set, ctx) {
            let step = function (completion) {
                ctx.save();
                start.component.draw(Frame_1.default.interpolate(start, end, completion), ctx);
                ctx.restore();
            };
